...
//
// FI_XME: instead of replacing debug metadata, this pass should allow for
...
public:
  ...
  void visitInstruction(Instruction &I) {
    ...
    unsigned Col = 0; // FIX_ME: support columns
    unsigned Line;
...
private:
  ...
  DISubprogram *findDISubprogram(const Function *F) {
    ...
    // TO_DO: When would this even be reached?
    for (DISubprogram *S : Finder.subprograms()) {
      // TOD_O: Is describes correct?
      if (S->describes(F)) {
