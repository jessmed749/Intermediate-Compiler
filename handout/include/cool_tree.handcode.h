...
#define program_EXTRAS                                                         \
    ...
    void cgen(const std::optional<std::string> &) override;
...
#define method_EXTRAS                                                          \
    virtual Symbol get_return_type_decl() { return return_type_decl; }                   \
...
#define branch_EXTRAS                                                          \
    ...
    llvm::Value *code(llvm::Value *expr_val, llvm::Value *tag,                 \
                    llvm::Type *join_type, CgenEnvironment *env) override;          \
    /*void dump_with_types(std::ostream &, int);*/
