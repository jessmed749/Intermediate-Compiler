...
class Feature_class : public tree_node
{
  public:
    ...
    virtual bool is_attr() const { return false; }  //check on cgen
...
class program_class : public Program_class
{
  ...
  public:
    ...
    Program copy_Program() override;                // <--- added override
    void dump(std::ostream &stream, int n) override; // <--- added override
...
class class__class : public Class__class
{
  ...
  public:
    ...
    void dump(std::ostream &stream, int n) override;
...
class method_class : public Feature_class
{
  ...
  public:
    ...
    void dump(std::ostream &stream, int n) override;
    //virtual bool is_attr() const override { return false; }
    Symbol get_return_type() const { return return_type_decl; }
...
class attr_class : public Feature_class
{
  ...
  public:
    ...
    bool is_attr() const override { return true; } //used in setup_main
...
class formal_class : public Formal_class
{
  ...
  public:
    ...
    Formal copy_Formal() override;  // Add override
    void dump(std::ostream &stream, int n) override;  // Add override
...
class branch_class : public Case_class
{
  ...
  public:
    ...
    Case copy_Case() override;                      // <--- added override
    void dump(std::ostream &stream, int n) override;// <--- added override
...
class assign_class : public Expression_class
{
  ...
  public:
    ...
    Expression copy_Expression() override;          // <--- added override
    void dump(std::ostream &stream, int n) override;// <--- added override
...
class static_dispatch_class : public Expression_class
{
  ...
  public:
    ...
    Expression copy_Expression() override;  // Add override
    void dump(std::ostream &stream, int n) override;  // Add override
...
class no_expr_class : public Expression_class
{
  ...
  public:
    no_expr_class() {}
    virtual bool is_no_expr() const override { return true; }
    Expression copy_Expression() override;  // Add override
    void dump(std::ostream &stream, int n) override;  // Add override
