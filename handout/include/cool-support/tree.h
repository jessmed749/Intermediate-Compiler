...
class list_node_iterator
{
  ...
  public:
    ...
    bool operator!=(list_node_iterator<Elem> const &rhs) const
    {
...
template<class Elem>
list_node_iterator<Elem> begin(list_node<Elem> &list)
{
    return list_node_iterator<Elem>(&list);
}

template<class Elem>
list_node_iterator<Elem> end(list_node<Elem> &list)
{
...
template<class Elem>
int list_node<Elem>::next(int n)
{
    return n + 1;
}

template<class Elem>
int list_node<Elem>::more(int n)
{
    return n < len();
}
...
///////////////////////////////////////////////////////////////////////////
template<class Elem>
void nil_node<Elem>::dump(std::ostream &stream, int n)
{
    stream << pad(n) << "(nil)\n";
}
...
template<class Elem>
list_node<Elem> *list_node<Elem>::nil()
{
    return new nil_node<Elem>();
}
template<class Elem>
list_node<Elem> *list_node<Elem>::single(Elem e)
{
...
Elem list_node<Elem>::nth(int n)
{
    ...
    tmp = nth_length(n, len);

    if (tmp)
    {
        return tmp;
    }
    assert(0 && "nth: outside the range of the list");

    return tmp; // Unreachable, but stops some warnings
}
